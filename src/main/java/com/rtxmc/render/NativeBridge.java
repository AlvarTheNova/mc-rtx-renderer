...
public final class NativeBridge {
     ...
     *  vertexCount is needed because native filters by stride (bytes/count). */
    public static native void uploadEntityBatch(int layerHash, int vertexCount, ByteBuffer vertices);
